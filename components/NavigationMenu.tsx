...
import { CircleCheckIcon, CircleHelpIcon, CircleIcon, Globe, HelpCircle, House, LayoutDashboard, Moon } from "lucide-react"
  ...
  return (
    <div className="flex justify-between">
      <div className="flex items-center">
        ...
        <NavigationMenu viewport={false} className="flex justify-between w-full">
          <NavigationMenuList>
            <NavigationMenuItem>
            ...
            <NavigationMenuItem>
              <NavigationMenuTrigger>Trading Bots</NavigationMenuTrigger>
              <NavigationMenuContent>
            ...
            <NavigationMenuItem>
              <NavigationMenuLink asChild className={navigationMenuTriggerStyle()}>
                <Link href="/docs">Copy Trading</Link>
              </NavigationMenuLink>
            </NavigationMenuItem>
            <NavigationMenuItem>
              <NavigationMenuLink asChild className={navigationMenuTriggerStyle()}>
                <Link href="/docs">Smart Money</Link>
              </NavigationMenuLink>
            </NavigationMenuItem>
            <NavigationMenuItem>
      ...
      <div className="flex items-center gap-3">
        ...
        <HelpCircle className="h-5 w-5 text-white cursor-pointer" />
        <LayoutDashboard className="h-5 w-5 text-white cursor-pointer" />
        <ModeToggle />
      </div>
    </div>
  )
